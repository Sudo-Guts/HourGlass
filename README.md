...
├── [Matrix.c](https://github.com/Sudo-Guts/HourGlass/blob/main/Matrix.c) / [Matrix.h](https://github.com/Sudo-Guts/HourGlass/blob/main/Matrix.h)   # Control de matrices MAX7219 (buffer, refresco)  
├── [MPU6050.c](https://github.com/Sudo-Guts/HourGlass/blob/main/MPU6050.c) / [MPU6050.h](https://github.com/Sudo-Guts/HourGlass/blob/main/MPU6050.h)   # Lectura del acelerómetro  
├── [LCD.c](https://github.com/Sudo-Guts/HourGlass/blob/main/LCD.c) / [LCD.h](https://github.com/Sudo-Guts/HourGlass/blob/main/LCD.h)   # Driver para LCD 16x2 en modo 4 bits  
├── [Timer.c](https://github.com/Sudo-Guts/HourGlass/blob/main/Timer.c) / [Timer.h](https://github.com/Sudo-Guts/HourGlass/blob/main/Timer.h)   # Timer1 para base de tiempo de 1 segundo  
├── [Hourglass.c](https://github.com/Sudo-Guts/HourGlass/blob/main/Hourglass.c) / [Hourglass.h](https://github.com/Sudo-Guts/HourGlass/blob/main/Hourglass.h)   # Lógica principal del reloj de arena  
└── README.md   # Este archivo  


## 📜 Diagrama de conexión

![Logo](https://github.com/Sudo-Guts/HourGlass/blob/main/Pictures/Diagrama.jpg)
